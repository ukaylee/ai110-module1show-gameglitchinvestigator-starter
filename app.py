...
if submit:
    ...
    if not ok:
        ...
        # FIXME: The secret is sometimes treated as a string and sometimes as an int, causing the check_guess logic to fail. FIXED
        # FIX: Removed if statement and only kept the line that doesn't cast to the string.
